...
public class JacksonExecutor {
    ...
    public static void writeJackson() {
        try {
            ...
            objectMapper.writerWithDefaultPrettyPrinter().writeValue(new File("src/main/java/com/solvd/it_company/parsers/jackson/company.json"), company);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public static void readJackson() throws IOException {
        ...
        Company company = objectMapper.readValue(new File("src/main/java/com/solvd/it_company/parsers/jackson/company.json"), Company.class);
